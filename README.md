# act [![build status](https://travis-ci.org/imaginate/act.svg?branch=master)](https://travis-ci.org/imaginate/act) [![npm version](https://img.shields.io/badge/npm-1.2.0-brightgreen.svg?style=flat)](https://www.npmjs.com/package/node-act)
